...
var Calendaring = /** @class */ (function() {
  function Calendaring(gapiClient) {
    this.calendar = googleapis_1.google.calendar({
      version: 'v3',
      auth: gapiClient.auth,
    });
  }
  Calendaring.prototype.book = function(order) {
    return __awaiter(this, void 0, void 0, function() {
      var email, _i, _a, item;
      return __generator(this, function(_b) {
        email = order.billing_email && order.billing_email.toLowerCase() || '';
  ...
  Calendaring.prototype.addCustomerToEligibleEvent = function(
      sku, userId, email) {
    return __awaiter(this, void 0, void 0, function() {
      var listEvents, skuId, listResponse, event, updateEvent;
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            skuId = '#' + sku;
            console.log(
                'Searching for event with sku ' + skuId + ' for customer ' +
                userId + '.');
            return [
              4 /*yield*/, listEvents({
          ...
          case 1:
            ...
            if (event.attendees.find(function(attendee) {
                  return attendee.email.toLowerCase() === email;
                })) {
              console.log(
                  'Customer ' + userId + ' already invited to event ' +
                  event.id + '.');
              return [2 /*return*/];
            }
          ...
          case 2:
            _a.sent();
            console.log(
                'Customer ' + userId + ' added to event ' + event.id + '.');
            return [2 /*return*/];
        }
      });
    });
