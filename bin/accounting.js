      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!authorized) {
              console.error(
                  'Cannot send order ' + orderId +
                  ' to accounting. Not authorized.');
              return [2 /*return*/];
            }
            email =
          ...
          case 2:
            ...
            return [
              4 /*yield*/, this.client.createCustomer({
                email: email,
          ...
          case 4:
            if (!customer) {
              console.error(
                  'Customer ' + order.user_id + ' could not be created.');
              return [2 /*return*/];
            }
          ...
          case 7:
            console.log(
                'Created invoice ' + invoice.Id + ' for order ' + orderId +
                '.');
            return [3 /*break*/, 9];
          case 8:
            e_1 = _a.sent();
