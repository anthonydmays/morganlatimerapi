...
var GapiClient = /** @class */ (function() {
  ...
  GapiClient.prototype.doAuth = function() {
    return __awaiter(this, void 0, void 0, function() {
      var config, _a, _b, _c, client_secret, client_id, redirect_uris, token,
          _d;
        ...
        switch (_e.label) {
          case 0:
            ...
            return [
              ...
              gcloud_storage_utils_1.readFile(
                  gcloud_storage_utils_1.CONFIG_BUCKET, GCAL_CONFIG_FILE)
            ];
          case 1:
            config = _b.apply(_a, [_e.sent()]);
            _c = config.installed, client_secret = _c.client_secret,
            client_id = _c.client_id, redirect_uris = _c.redirect_uris;
            this._auth = new googleapis_1.google.auth.OAuth2(
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              gcloud_storage_utils_1.readFile(
                  gcloud_storage_utils_1.CONFIG_BUCKET, TOKEN_FILE)
            ];
          case 3:
            token = _e.sent();
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/, questionAsync('Enter the code from that page here: ')
            ];
          case 1:
            code = _a.sent();
