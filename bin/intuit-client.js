    ...
    IntuitClient.prototype.authorize = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.promisedOAuthClient];
                    case 1:
                        oAuthClient = _c.sent();
                        _c.label = 2;
                    case 2:
                        _c.trys.push([2, 4, , 5]);
                        _b = (_a = JSON).parse;
                        return [4 /*yield*/, gcloud_storage_utils_1.readFile(gcloud_storage_utils_1.CONFIG_BUCKET, this.config.tokenFile)];
                    case 3:
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/, oAuthClient.authorizeUri({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        oAuthClient = _a.sent();
                        return [2 /*return*/, new node_quickbooks_1.default(this.config.clientId, this.config.clientSecret, oAuthClient.token.access_token, false, '' + oAuthClient.token.realmId, this.config.environment === 'sandbox', this.config.debug, 34, '2.0', oAuthClient.token.refresh_token)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, gcloud_storage_utils_1.writeFile(gcloud_storage_utils_1.CONFIG_BUCKET, this.config.tokenFile, JSON.stringify(token))];
                    case 1:
                        _a.sent();
...
var INTUIT_CONFIG_FILE = 'intuit_config.dev.json';
