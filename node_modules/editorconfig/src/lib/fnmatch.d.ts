 ...
 */
declare function M(
    target: string, pattern: string, options?: M.IOptions): boolean;
...
declare namespace M {
   ...
   * Array.filter
   */
  function filter(pattern: string, options?: IOptions): (
  ...
  interface IMinimatch {
    ...
    /**
     * Take a /-split filename, and match it against a single row in the
     * regExpSet. This method is mainly for internal use, but is exposed so that
     * it can be used by a glob-walker that needs to avoid excessive filesystem
     * calls.
     */
