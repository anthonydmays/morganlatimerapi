...
function run(
    ...
    getStdinFn = get_stdin_1.default  // Used for mocking
) {
  return __awaiter(this, void 0, void 0, function*() {
    ...
    try {
      ...
      if (['pre-push', 'pre-receive', 'post-receive', 'post-rewrite'].includes(
              hookName)) {
      ...
      if (oldCommand) {
        console.log();
        console.log(`Warning: Setting ${
            hookName} script in package.json > scripts will be deprecated`);
        console.log(
      ...
      const noVerifyMessage =
          ['commit-msg', 'pre-commit', 'pre-rebase', 'pre-push'].includes(
              hookName) ?
