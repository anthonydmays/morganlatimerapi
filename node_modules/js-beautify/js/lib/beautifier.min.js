!function(t, e) {
  'object' == typeof exports&& 'object' == typeof module ?
      ...
      define('beautifier', [], e) :
      'object' == typeof exports ? exports.beautifier = e() : t.beautifier = e()
}(
    ...
    function() {
      return function(t) {
        ...
        function(t, e, i) {
          'use strict';
          var n = i(5).InputScanner, _ = i(1).Tokenizer, s = i(1).TOKEN,
              a = i(6).Directives, u = i(8), r = i(2).Pattern,
              o = i(10).TemplatablePattern;
          function p(t, e) {
          ...
          var h = {
            ...
            EOF: s.EOF
              ...
              l = new a(/\/\*/, /\*\//),
              c = /0[xX][0123456789abcdefABCDEF]*|0[oO][01234567]*|0[bB][01]*|\d+n|(?:\.\d+|\d+\.?\d*)(?:[eE][+-]?\d+)?/,
              f = /[0-9]/, d = /[^\d\.]/,
              b = '>>> === !== << && >= ** != == <= >> || < / - + > : & % ? ^ | *'
                      .split(' '),
              g = '>>>= ... >>= <<= === >>> !== **= => ^= :: /= << <= == && -= >= >> != -- += ** || ++ %= &= *= |= = ! ? > < : / ^ - + * & % ~ |';
          ...
          var m,
              k = new RegExp(g),
              w = 'continue,try,throw,return,var,let,const,if,switch,case,default,for,while,break,function,import,export'
                      .split(','),
              y = w.concat([
                'do', 'in', 'of', 'else', 'get', 'set', 'new', 'catch',
                'finally', 'typeof', 'yield', 'async', 'await', 'from', 'as'
              ]),
              x = new RegExp('^(?:' + y.join('|') + ')$'), v = function(t, e) {
                _.call(this, t, e),
                    this._patterns
                        .whitespace = this._patterns.whitespace.matching(
                        /\u00A0\u1680\u180e\u2000-\u200a\u202f\u205f\u3000\ufeff/
                            .source,
                        /\u2028\u2029/.source);
                var i = new r(this._input), n = new o(this._input);
                n = (n = n.disable('handlebars')).disable('django'),
                this.__patterns = {
                  template: n,
                  identifier:
                      n.starting_with(u.identifier).matching(u.identifierMatch),
                  number: i.matching(c),
                  punct: i.matching(k),
                  ...
                  include: i.starting_with(/#include/).until_after(u.lineBreak),
                  shebang: i.starting_with(/#!/).until_after(u.lineBreak),
                  xml: i.matching(
          ...
          (v.prototype = new _)
              ._is_comment =
              function(t) {
            return t.type === h.COMMENT || t.type === h.BLOCK_COMMENT ||
                t.type === h.UNKNOWN
          },
            v.prototype._is_opening =
                function(t) {
              return t.type === h.START_BLOCK || t.type === h.START_EXPR
            },
            v.prototype._is_closing =
                function(t, e) {
              ...
              return null === n ?
                  ...
                  i = (i = (i = (i = (i = (i = (i = (i = (i = i ||
                                                              this._read_string(
                                                                  n)) ||
                                                         this._read_word(t)) ||
                                                    this._read_singles(n)) ||
                                               this._read_comment(n)) ||
                                          this._read_regexp(n, t)) ||
                                     this._read_xml(n, t)) ||
                                this._read_non_javascript(n)) ||
                           this._read_punctuation()) ||
                      this._create_token(h.UNKNOWN, this._input.next())
            },
            v.prototype._read_word =
                function(t) {
              var e;
            ...
            v.prototype._read_singles =
              ...
              return '(' === t || '[' === t ?
                         ...
                         e && this._input.next(), e
            },
            v.prototype._read_punctuation =
                function() {
              var t = this.__patterns.punct.read();
              if ('' !== t)
                return '=' === t ? this._create_token(h.EQUALS, t) :
                                   this._create_token(h.OPERATOR, t)
            },
            v.prototype._read_non_javascript =
                function(t) {
              var e = '';
              if ('#' === t) {
                  ...
                  return '#' === t ||
                             ('[' === this._input.peek() &&
                                  ...
                                  '{' === this._input.peek() &&
                                      ...
                                      (i += '{}', this._input.next(),
                                       this._input.next())),
                         this._create_token(h.WORD, i)
                }
                this._input.back()
              } else if ('<' === t) {
                if (e = this.__patterns.html_comment_start.read()) {
                  for (; this._input.hasNext() &&
                ...
                return m = !1, this._create_token(h.COMMENT, e);
              return null
            },
            v.prototype._read_comment =
                function(t) {
              var e = null;
              if ('/' === t) {
                var i = '';
                if ('*' === this._input.peek(1)) {
                  ...
                  n && 'start' === n.ignore &&
                      (i += l.readIgnored(this._input)),
                      i = i.replace(u.allLineBreaks, '\n'),
                      (e = this._create_token(h.BLOCK_COMMENT, i)).directives =
                          n
                } else
                  '/' === this._input.peek(1) &&
                      (i = this.__patterns.comment.read(),
                       e = this._create_token(h.COMMENT, i))
              }
              return e
            },
            v.prototype._read_string =
                function(t) {
              if ('`' === t || '\'' === t || '"' === t) {
                ...
                return this.has_char_escapes = !1,
                       ...
                       this.has_char_escapes &&
                           ...
                           (e =
                                function(t) {
                                  var e = '', i = 0, _ = new n(t), s = null;
                                  for (; _.hasNext();)
                                    if ((s = _.match(/([\s]|[^\\]|\\\\)+/g)) &&
                                            (e += s[0]),
                                        '\\' === _.peek()) {
                                      if (_.next(), 'x' === _.peek())
                                        s = _.match(/x([0-9A-Fa-f]{2})/g);
                                      else {
                                        if ('u' !== _.peek()) {
                                          e += '\\',
                                              _.hasNext() && (e += _.next());
                                        ...
                                        s = _.match(/u([0-9A-Fa-f]{4})/g)
                                      }
                                      if (!s) return t;
                                      if ((i = parseInt(s[1], 16)) > 126 &&
                                          i <= 255 && 0 === s[0].indexOf('x'))
                                        return t;
                                      if (i >= 0 && i < 32) {
                                        e += '\\' + s[0];
                                        continue
            ...
            v.prototype._allow_regexp_or_xml =
                function(t) {
              return t.type === h.RESERVED &&
                  p(t.text,
                    [
                  ...
                  p(t.opened.previous.text, ['if', 'while', 'for']) ||
                  p(t.type, [
                       h.COMMENT, h.START_EXPR, h.START_BLOCK, h.START,
                       h.END_BLOCK, h.OPERATOR, h.EQUALS, h.EOF, h.SEMICOLON,
                       h.COMMA
                     ])
            },
            v.prototype._read_regexp =
                function(t, e) {
              if ('/' === t && this._allow_regexp_or_xml(e)) {
                for (var i = this._input.next(), n = !1, _ = !1;
                     this._input.hasNext() &&
                     (n || _ || this._input.peek() !== t) &&
                     !this._input.testChar(u.newline);)
                  i += this._input.peek(),
                      n ? n = !1 :
                          (n = '\\' === this._input.peek(),
                           '[' === this._input.peek() ?
                               _ = !0 :
                               ']' === this._input.peek() && (_ = !1)),
                          this._input.next();
                return this._input.peek() === t &&
                           (i += this._input.next(),
                            i += this._input.read(u.identifier)),
                       this._create_token(h.STRING, i)
              }
              return null
            },
            v.prototype._read_xml =
                function(t, e) {
              if (this._options.e4x && '<' === t &&
                  this._allow_regexp_or_xml(e)) {
                var i = '', n = this.__patterns.xml.read_match();
                if (n) {
                  for (var _ = n[2].replace(/^{\s+/, '{').replace(/\s+}$/, '}'),
                           s = 0 === _.indexOf('{'), a = 0;
                       n;) {
                    var r = !!n[1], o = n[2];
                    if (!(!!n[n.length - 1] || '![CDATA[' === o.slice(0, 8)) &&
                            (o === _ ||
                             s &&
                                 o.replace(/^{\s+/, '{')
                                     .replace(/\s+}$/, '}')) &&
                  ...
                  return n || (i += this._input.match(/[\s\S]*/g)[0]),
                         i = i.replace(u.allLineBreaks, '\n'),
                         this._create_token(h.STRING, i)
                }
              }
            ...
            v.prototype._read_string_recursive =
                function(t, e, i) {
              var n, _;
              '\'' === t ?
                  _ = this.__patterns.single_quote :
                  '"' === t ? _ = this.__patterns.double_quote :
                              '`' === t ? _ = this.__patterns.template_text :
                                          '}' === t &&
                              (_ = this.__patterns.template_expression);
              for (var s = _.read(), a = ''; this._input.hasNext();) {
                if ((a = this._input.next()) === t || !e && u.newline.test(a)) {
                  this._input.back();
                  break
                }
            ...
            t.exports.Tokenizer = v, t.exports.TOKEN = h,
            t.exports.positionable_operators = b.slice(),
            t.exports.line_starters = w.slice()
        },
        function(t, e, i) {
          'use strict';
          var n = i(5).InputScanner, _ = i(7).Token, s = i(17).TokenStream,
              a = i(18).WhitespacePattern,
              u = {START: 'TK_START', RAW: 'TK_RAW', EOF: 'TK_EOF'},
              r = function(t, e) {
                this._input = new n(t), this._options = e || {},
                this.__tokens = null, this._patterns = {},
          ...
          r.prototype.tokenize = function() {
            ...
            for (var e = new _(u.START, ''), i = null, n = [], a = new s;
                 e.type !== u.EOF;) {
              for (t = this._get_next_token(e, i); this._is_comment(t);)
                a.add(t), t = this._get_next_token(e, i);
              a.isEmpty() || (t.comments_before = a, a = new s),
                  t.parent = i,
                  this._is_opening(t) ? (n.push(i), i = t) :
                                        i && this._is_closing(t, i) &&
                      (t.opened = i, i.closed = t, i = n.pop(), t.parent = i),
                  t.previous = e, e.next = t, this.__tokens.add(t), e = t
            }
            ...
            return i ? this._create_token(u.RAW, i) :
            ...
            return new _(
                t, e, this._patterns.whitespace.newline_count,
        ...
        function(t, e, i) {
          'use strict';
          function n(t, e) {
            this._input = t, this._starting_pattern = null,
            this._match_pattern = null, this._until_pattern = null,
            this._until_after = !1,
            e &&
                (this._starting_pattern =
                     this._input.get_regexp(e._starting_pattern, !0),
                 this._match_pattern =
                     this._input.get_regexp(e._match_pattern, !0),
          ...
          n.prototype.read = function() {
            ...
            return this._starting_pattern && !t ||
                       (t += this._input.read(
                            this._match_pattern, this._until_pattern,
                            this._until_after)),
                   t
            ...
            return e._until_after = !0,
                   e._until_pattern = this._input.get_regexp(t), e._update(), e
        ...
        function(t, e, i) {
          'use strict';
          function n(t) {
            this.__parent = t, this.__character_count = 0,
            this.__indent_count = -1, this.__alignment_count = 0,
            this.__wrap_point_index = 0, this.__wrap_point_character_count = 0,
            this.__wrap_point_indent_count = -1,
            this.__wrap_point_alignment_count = 0, this.__items = []
          }
          function _(t, e) {
            this.__cache = [''], this.__indent_size = t.indent_size,
            this.__indent_string = t.indent_char,
            t.indent_with_tabs ||
                (this.__indent_string =
                     new Array(t.indent_size + 1).join(t.indent_char)),
            e = e || '',
            t.indent_level > 0 &&
                (e = new Array(t.indent_level + 1).join(this.__indent_string)),
            this.__base_string = e, this.__base_string_length = e.length
          }
          function s(t, e) {
            this.__indent_cache = new _(t, e), this.raw = !1,
            this._end_with_newline = t.end_with_newline,
            this.indent_size = t.indent_size,
            this.wrap_line_length = t.wrap_line_length, this.__lines = [],
            this.previous_line = null, this.current_line = null,
            this.next_line = new n(this), this.space_before_token = !1,
            this.non_breaking_space = !1, this.previous_token_wrapped = !1,
   ...
   n.prototype.item = function(t) {
     ...
     this.is_empty() &&
         (this.__indent_count = t || 0, this.__alignment_count = e || 0,
          this.__character_count = this.__parent.get_indent_size(
              this.__indent_count, this.__alignment_count))
     ...
     return e = e || 0, t < 0 && (t = 0, i = ''), e += t * this.__indent_size,
            this.__ensure_cache(e), i += this.__cache[e]
     ...
     return !(this.is_empty() || !t && this.just_added_newline()) &&
     ...
     return t = t || 0, e = e || 0, this.next_line.set_indent(t, e),
            this.__lines.length > 1 ? (this.current_line.set_indent(t, e), !0) :
     ...
     this.current_line.set_indent(-1),
         ...
         this.current_line.push(t.text), this.space_before_token = !1,
                                         this.non_breaking_space = !1,
                                         this.previous_token_wrapped = !1
   }, s.prototype.add_token = function(t) {
     this.__add_space_before_token(), this.current_line.push(t),
         this.space_before_token = !1, this.non_breaking_space = !1,
         this.previous_token_wrapped = this.current_line._allow_wrap()
   }, s.prototype.__add_space_before_token = function() {
     this.space_before_token && !this.just_added_newline() &&
     ...
     for (t = void 0 !== t && t, this.current_line.trim();
     ...
     for (var i = this.__lines.length - 2; i >= 0;) {
       ...
       if (0 !== _.item(0).indexOf(t) && _.item(-1) !== e) {
         this.__lines.splice(i + 1, 0, new n(this)),
       ...
       i--
        ...
        function(t, e, i) {
          ...
          n.prototype._get_array =
              function(t, e) {
            var i = this.raw_options[t], n = e || [];
            return 'object' == typeof i ? null !== i &&
                           'function' == typeof i.concat && (n = i.concat()) :
                                          'string' == typeof i &&
                           (n = i.split(/[^a-zA-Z0-9_\/\-]+/)),
                   n
          },
          n.prototype._get_boolean =
              function(t, e) {
            var i = this.raw_options[t];
            return void 0 === i ? !!e : !!i
          },
          n.prototype._get_characters =
              function(t, e) {
            var i = this.raw_options[t], n = e || '';
          ...
          n.prototype._get_selection_list =
              function(t, e, i) {
            if (!e || 0 === e.length)
          ...
          n.prototype._is_valid_selection =
              function(t, e) {
            return t.length && e.length && !t.some(function(t) {
              return -1 === e.indexOf(t)
            })
          },
          t.exports.Options = n, t.exports.normalizeOpts = s,
        ...
        function(t, e, i) {
          ...
          function _(t) {
            this.__input = t || '', this.__input_length = this.__input.length,
            this.__position = 0
          }
          _.prototype.restart = function() {
            ...
            var e = null;
            return t = t || 0,
                   (t += this.__position) >= 0 && t < this.__input_length &&
            ...
            return e = e || 0,
                   (e += this.__position) >= 0 && e < this.__input_length &&
                       !!this.__match(t, e)
        ...
        function(t, e, i) {
          ...
          function n(t, e) {
            ...
            this.__directives_block_pattern =
                new RegExp(t + / beautify( \w+[:]\w+)+ /.source + e, 'g'),
            this.__directive_pattern = / (\w+)[:](\w+)/g,
            this.__directives_end_ignore_pattern =
                new RegExp(t + /\sbeautify\signore:end\s/.source + e, 'g')
          }
        ...
        function(t, e, i) {
          ...
          t.exports.Token = function(t, e, i, n) {
            this.type = t, this.text = e, this.comments_before = null,
            this.newlines = i || 0, this.whitespace_before = n || '',
            this.parent = null, this.next = null, this.previous = null,
            this.opened = null, this.closed = null, this.directives = null
          }
        },
        function(t, e, i) {
          'use strict';
          var n = '\\xaa\\xb5\\xba\\xc0-\\xd6\\xd8-\\xf6\\xf8-\\u02c1\\u02c6-\\u02d1\\u02e0-\\u02e4\\u02ec\\u02ee\\u0370-\\u0374\\u0376\\u0377\\u037a-\\u037d\\u0386\\u0388-\\u038a\\u038c\\u038e-\\u03a1\\u03a3-\\u03f5\\u03f7-\\u0481\\u048a-\\u0527\\u0531-\\u0556\\u0559\\u0561-\\u0587\\u05d0-\\u05ea\\u05f0-\\u05f2\\u0620-\\u064a\\u066e\\u066f\\u0671-\\u06d3\\u06d5\\u06e5\\u06e6\\u06ee\\u06ef\\u06fa-\\u06fc\\u06ff\\u0710\\u0712-\\u072f\\u074d-\\u07a5\\u07b1\\u07ca-\\u07ea\\u07f4\\u07f5\\u07fa\\u0800-\\u0815\\u081a\\u0824\\u0828\\u0840-\\u0858\\u08a0\\u08a2-\\u08ac\\u0904-\\u0939\\u093d\\u0950\\u0958-\\u0961\\u0971-\\u0977\\u0979-\\u097f\\u0985-\\u098c\\u098f\\u0990\\u0993-\\u09a8\\u09aa-\\u09b0\\u09b2\\u09b6-\\u09b9\\u09bd\\u09ce\\u09dc\\u09dd\\u09df-\\u09e1\\u09f0\\u09f1\\u0a05-\\u0a0a\\u0a0f\\u0a10\\u0a13-\\u0a28\\u0a2a-\\u0a30\\u0a32\\u0a33\\u0a35\\u0a36\\u0a38\\u0a39\\u0a59-\\u0a5c\\u0a5e\\u0a72-\\u0a74\\u0a85-\\u0a8d\\u0a8f-\\u0a91\\u0a93-\\u0aa8\\u0aaa-\\u0ab0\\u0ab2\\u0ab3\\u0ab5-\\u0ab9\\u0abd\\u0ad0\\u0ae0\\u0ae1\\u0b05-\\u0b0c\\u0b0f\\u0b10\\u0b13-\\u0b28\\u0b2a-\\u0b30\\u0b32\\u0b33\\u0b35-\\u0b39\\u0b3d\\u0b5c\\u0b5d\\u0b5f-\\u0b61\\u0b71\\u0b83\\u0b85-\\u0b8a\\u0b8e-\\u0b90\\u0b92-\\u0b95\\u0b99\\u0b9a\\u0b9c\\u0b9e\\u0b9f\\u0ba3\\u0ba4\\u0ba8-\\u0baa\\u0bae-\\u0bb9\\u0bd0\\u0c05-\\u0c0c\\u0c0e-\\u0c10\\u0c12-\\u0c28\\u0c2a-\\u0c33\\u0c35-\\u0c39\\u0c3d\\u0c58\\u0c59\\u0c60\\u0c61\\u0c85-\\u0c8c\\u0c8e-\\u0c90\\u0c92-\\u0ca8\\u0caa-\\u0cb3\\u0cb5-\\u0cb9\\u0cbd\\u0cde\\u0ce0\\u0ce1\\u0cf1\\u0cf2\\u0d05-\\u0d0c\\u0d0e-\\u0d10\\u0d12-\\u0d3a\\u0d3d\\u0d4e\\u0d60\\u0d61\\u0d7a-\\u0d7f\\u0d85-\\u0d96\\u0d9a-\\u
83\\u0cbc\\u0cbe-\\u0cc4\\u0cc6-\\u0cc8\\u0cca-\\u0ccd\\u0cd5\\u0cd6\\u0ce2-\\u0ce3\\u0ce6-\\u0cef\\u0d02\\u0d03\\u0d46-\\u0d48\\u0d57\\u0d62-\\u0d63\\u0d66-\\u0d6f\\u0d82\\u0d83\\u0dca\\u0dcf-\\u0dd4\\u0dd6\\u0dd8-\\u0ddf\\u0df2\\u0df3\\u0e34-\\u0e3a\\u0e40-\\u0e45\\u0e50-\\u0e59\\u0eb4-\\u0eb9\\u0ec8-\\u0ecd\\u0ed0-\\u0ed9\\u0f18\\u0f19\\u0f20-\\u0f29\\u0f35\\u0f37\\u0f39\\u0f41-\\u0f47\\u0f71-\\u0f84\\u0f86-\\u0f87\\u0f8d-\\u0f97\\u0f99-\\u0fbc\\u0fc6\\u1000-\\u1029\\u1040-\\u1049\\u1067-\\u106d\\u1071-\\u1074\\u1082-\\u108d\\u108f-\\u109d\\u135d-\\u135f\\u170e-\\u1710\\u1720-\\u1730\\u1740-\\u1750\\u1772\\u1773\\u1780-\\u17b2\\u17dd\\u17e0-\\u17e9\\u180b-\\u180d\\u1810-\\u1819\\u1920-\\u192b\\u1930-\\u193b\\u1951-\\u196d\\u19b0-\\u19c0\\u19c8-\\u19c9\\u19d0-\\u19d9\\u1a00-\\u1a15\\u1a20-\\u1a53\\u1a60-\\u1a7c\\u1a7f-\\u1a89\\u1a90-\\u1a99\\u1b46-\\u1b4b\\u1b50-\\u1b59\\u1b6b-\\u1b73\\u1bb0-\\u1bb9\\u1be6-\\u1bf3\\u1c00-\\u1c22\\u1c40-\\u1c49\\u1c5b-\\u1c7d\\u1cd0-\\u1cd2\\u1d00-\\u1dbe\\u1e01-\\u1f15\\u200c\\u200d\\u203f\\u2040\\u2054\\u20d0-\\u20dc\\u20e1\\u20e5-\\u20f0\\u2d81-\\u2d96\\u2de0-\\u2dff\\u3021-\\u3028\\u3099\\u309a\\ua640-\\ua66d\\ua674-\\ua67d\\ua69f\\ua6f0-\\ua6f1\\ua7f8-\\ua800\\ua806\\ua80b\\ua823-\\ua827\\ua880-\\ua881\\ua8b4-\\ua8c4\\ua8d0-\\ua8d9\\ua8f3-\\ua8f7\\ua900-\\ua909\\ua926-\\ua92d\\ua930-\\ua945\\ua980-\\ua983\\ua9b3-\\ua9c0\\uaa00-\\uaa27\\uaa40-\\uaa41\\uaa4c-\\uaa4d\\uaa50-\\uaa59\\uaa7b\\uaae0-\\uaae9\\uaaf2-\\uaaf3\\uabc0-\\uabe1\\uabec\\uabed\\uabf0-\\uabf9\\ufb20-\\ufb28\\ufe00-\\ufe0f\\ufe20-\\ufe26\\ufe33\\ufe34\\ufe4d-\\ufe4f\\uff10-\\uff19\\uff3f])*',
              'g'),
        ...
        function(t, e, i) {
          ...
          function s(t) {
            ...
            'expand-strict' === e ?
                ...
                void 0 !== this.raw_options.braces_on_own_line &&
                        (this.raw_options.brace_style =
                             this.raw_options.braces_on_own_line ? 'expand' :
                                                                   'collapse');
            ...
            for (var s = 0; s < i.length; s++)
              'preserve-inline' === i[s] ? this.brace_preserve_inline = !0 :
                                           this.brace_style = i[s];
            this.unindent_chained_methods =
                this._get_boolean('unindent_chained_methods'),
            this.break_chained_methods =
                this._get_boolean('break_chained_methods'),
            this.space_in_paren = this._get_boolean('space_in_paren'),
            this.space_in_empty_paren =
                this._get_boolean('space_in_empty_paren'),
            this.jslint_happy = this._get_boolean('jslint_happy'),
            this.space_after_anon_function =
                this._get_boolean('space_after_anon_function'),
            this.space_after_named_function =
                this._get_boolean('space_after_named_function'),
            this.keep_array_indentation =
                this._get_boolean('keep_array_indentation'),
            this.space_before_conditional =
                this._get_boolean('space_before_conditional', !0),
            this.unescape_strings = this._get_boolean('unescape_strings'),
            this.e4x = this._get_boolean('e4x'),
            this.comma_first = this._get_boolean('comma_first'),
            this.operator_position =
                this._get_selection('operator_position', _),
        ...
        function(t, e, i) {
          ...
          function s(t, e) {
            n.call(this, t, e), this.__template_pattern = null,
                                this._disabled = Object.assign({}, _),
                                this._excluded = Object.assign({}, _),
                                e &&
                (this.__template_pattern =
                     this._input.get_regexp(e.__template_pattern),
            ...
            if ('<' === e) {
              ...
              '{' === e &&
                  (this._disabled.handlebars || this._excluded.handlebars ||
                   ...
                   this._disabled.django ||
                       (this._excluded.django || this._excluded.handlebars ||
          ...
          function _(t) {
            n.call(this, t, 'css'),
                this.selector_separator_newline =
                    this._get_boolean('selector_separator_newline', !0),
                this.newline_between_rules =
                    this._get_boolean('newline_between_rules', !0);
          ...
          function _(t) {
            n.call(this, t, 'html'),
                ...
                this.indent_body_inner_html =
                    this._get_boolean('indent_body_inner_html', !0),
                this.indent_head_inner_html =
                    this._get_boolean('indent_head_inner_html', !0),
                this.indent_handlebars =
                    this._get_boolean('indent_handlebars', !0),
                this.wrap_attributes = this._get_selection(
                    'wrap_attributes',
                    [
                      'auto', 'force', 'force-aligned',
                      'force-expand-multiline', 'aligned-multiple', 'preserve',
                      'preserve-aligned'
                    ]),
                this.wrap_attributes_indent_size = this._get_number(
                    'wrap_attributes_indent_size', this.indent_size),
                this.extra_liners =
                    this._get_array('extra_liners', ['head', 'body', '/html']),
                this.inline = this._get_array(
                    'inline',
                    [
                      'a',        'abbr',     'area',   'audio',    'b',
                      ...
                      'label',    'map',      'mark',   'math',     'meter',
                      'noscript', 'object',   'output', 'progress', 'q',
                      'ruby',     's',        'samp',   'select',   'small',
                      'span',     'strong',   'sub',    'sup',      'svg',
                      'template', 'textarea', 'time',   'u',        'var',
                      'video',    'wbr',      'text',   'acronym',  'big',
                      'strike',   'tt'
                    ]),
                ...
                this.content_unformatted =
                    this._get_array('content_unformatted', ['pre', 'textarea']),
                this.unformatted_content_delimiter =
                    this._get_characters('unformatted_content_delimiter'),
        ...
        function(t, e, i) {
          'use strict';
          var n = i(1).Tokenizer, _ = i(1).TOKEN, s = i(6).Directives,
              a = i(10).TemplatablePattern, u = i(2).Pattern, r = {
              ...
              o = new s(/<\!--/, /-->/), p = function(t, e) {
                ...
                var i = new a(this._input), _ = new u(this._input);
                if (this.__patterns = {
                      word: i.until(/[\n\r\t <]/),
          ...
          (p.prototype = new n)._is_comment = function(t) {
            ...
            var n = this._input.peek();
            return null === n ?
                this._create_token(r.EOF, '') :
                i = (i = (i = (i = (i = (i = (i = (i = i ||
                                                       this._read_open_handlebars(
                                                           n, e)) ||
                                                  this._read_attribute(
                                                      n, t, e)) ||
                                             this._read_raw_content(t, e)) ||
            ...
            if ('<' === t) {
              ...
              '<' !== t || '!' !== _ && '?' !== _ ||
                  ((i = this.__patterns.comment.read()) ?
                       (n = o.get_directives(i)) && 'start' === n.ignore &&
                           (i += o.readIgnored(this._input)) :
                       i = (i = (i = this.__patterns.cdata.read()) ||
                                this.__patterns.conditional_comment.read()) ||
                           this.__patterns.processing.read()),
                  i && ((e = this._create_token(r.COMMENT, i)).directives = n)
            }
            return e
            ...
            return e ||
                       '<' === t &&
                           (i = this._input.next(),
                            ...
                            n = this._create_token(r.TAG_OPEN, i)),
                   n
          }, p.prototype._read_open_handlebars = function(t, e) {
            var i = null, n = null;
            return e ||
                       this._options.indent_handlebars && '{' === t &&
                           '{' === this._input.peek(1) &&
                           ('!' === this._input.peek(2) ?
                                (i = (i = this.__patterns.handlebars_comment
                                              .read()) ||
                                     this.__patterns.handlebars.read(),
                                 n = this._create_token(r.COMMENT, i)) :
            ...
            return e &&
                       ('<' === e.text[0] &&
                            ...
                            '{' === e.text[0] && '}' === t &&
                                '}' === this._input.peek(1) &&
                                (this._input.next(), this._input.next(),
                                 n = this._create_token(r.TAG_CLOSE, '}}'))),
                   n
          }, p.prototype._read_attribute = function(t, e, i) {
            var n = null, _ = '';
            if (i && '<' === i.text[0])
              if ('=' === t)
                n = this._create_token(r.EQUALS, this._input.next());
              else if ('"' === t || '\'' === t) {
                var s = this._input.next();
                s += '"' === t ? this.__patterns.double_quote.read() :
                                 this.__patterns.single_quote.read(),
                    n = this._create_token(r.VALUE, s)
              } else
                (_ = this.__patterns.attribute.read()) &&
                    (n = e.type === r.EQUALS ?
                         this._create_token(r.VALUE, _) :
                         this._create_token(r.ATTRIBUTE, _));
            return n
          }, p.prototype._is_content_unformatted = function(t) {
            return -1 === this._options.void_elements.indexOf(t) &&
                ('script' === t || 'style' === t ||
                 -1 !== this._options.content_unformatted.indexOf(t) ||
                 -1 !== this._options.unformatted.indexOf(t))
          }, p.prototype._read_raw_content = function(t, e) {
            var i = '';
            if (e && '{' === e.text[0])
              i = this.__patterns.handlebars_raw_close.read();
            else if (t.type === r.TAG_CLOSE && '<' === t.opened.text[0]) {
            ...
            if (this._options.unformatted_content_delimiter &&
                ...
                e || (e = this.__patterns.word.read()), e)
              return this._create_token(r.TEXT, e)
          }, t.exports.Tokenizer = p, t.exports.TOKEN = r
        },
        function(t, e, i) {
          'use strict';
          var n = i(15), _ = i(19), s = i(21);
          function a(t, e, i, a) {
            return s(t, e, i = i || n, a = a || _)
          }
          a.defaultOptions = s.defaultOptions, t.exports.js = n,
          t.exports.css = _, t.exports.html = a
        },
        function(t, e, i) {
          'use strict';
          var n = i(16).Beautifier, _ = i(9).Options;
        ...
        function(t, e, i) {
          'use strict';
          var n = i(3).Output, _ = i(7).Token, s = i(8), a = i(9).Options,
              u = i(0).Tokenizer, r = i(0).line_starters,
              o = i(0).positionable_operators, p = i(0).TOKEN;
          function h(t, e) {
            return -1 !== e.indexOf(t)
          }
          function l(t, e) {
          ...
          function c(t, e) {
            return t && t.type === p.RESERVED && h(t.text, e)
          }
          var f =
                  [
                    'case', 'return', 'do', 'if', 'throw', 'else', 'await',
              ...
              b = [d.before_newline, d.preserve_newline], g = {
          ...
          function m(t, e) {
            e.multiline_frame || e.mode === g.ForInitializer ||
                e.mode === g.Conditional || t.remove_indent(e.start_line_index)
          }
          function k(t) {
          ...
          function y(t, e) {
            e = e || {}, this._source_text = t || '', this._output = null,
            this._tokens = null, this._last_last_text = null,
            this._flags = null, this._previous_flags = null,
            this._flag_store = null, this._options = new a(e)
          }
          y.prototype.create_flags = function(t, e) {
            var i = 0;
            return t &&
            ...
            {
              mode: e, parent: t,
                  last_token: t ? t.last_token : new _(p.START_BLOCK, ''),
                  last_word: t ? t.last_word : '', declaration_statement: !1,
                  declaration_assignment: !1, multiline_frame: !1,
                  inline_frame: !1, if_block: !1, else_block: !1, do_block: !1,
                  do_while: !1, import_block: !1, in_case_statement: !1,
                  in_case: !1, case_body: !1, indentation_level: i,
                  alignment: 0, line_indent_level: t ? t.line_indent_level : i,
                  start_line_index: this._output.get_line_number(),
                  ternary_depth: 0
            }
          }, y.prototype._reset = function(t) {
            var e = t.match(/^[\t ]*/)[0];
            this._last_last_text = '', this._output = new n(this._options, e),
            this._output.raw = this._options.test_output_raw,
            this._flag_store = [], this.set_mode(g.BlockStatement);
            var i = new u(t, this._options);
            ...
            'auto' === this._options.eol &&
                (e = '\n',
                 t && s.lineBreak.test(t || '') &&
                     (e = t.match(s.lineBreak)[0]));
            for (var i = this._tokens.next(); i;)
              this.handle_token(i),
                  this._last_last_text = this._flags.last_token.text,
                  this._flags.last_token = i, i = this._tokens.next();
            return this._output.get_code(e)
          }, y.prototype.handle_token = function(t, e) {
            t.type === p.START_EXPR ?
          ...
          }, y.prototype.handle_whitespace_and_comments = function(t, e) {
            var i = t.newlines,
                n = this._options.keep_array_indentation && k(this._flags.mode);
            if (t.comments_before)
              for (var _ = t.comments_before.next(); _;)
                this.handle_whitespace_and_comments(_, e),
                    this.handle_token(_, e), _ = t.comments_before.next();
            if (n)
          ...
          y.prototype
            ...
            if (e = void 0 !== e && e, !this._output.just_added_newline()) {
              ...
              if (h(this._flags.last_token.text, o) || h(t.text, o)) {
                var n = h(this._flags.last_token.text, o) &&
                        h(this._options.operator_position, b) ||
                    h(t.text, o);
                i = i && n
              }
              if (i)
                ...
                if (c(this._flags.last_token, x)) return;
                this._output.set_wrap_point()
              }
            }
          },
   y.prototype.print_newline = function(t, e) {
     if (!e && ';' !== this._flags.last_token.text &&
         ',' !== this._flags.last_token.text &&
         '=' !== this._flags.last_token.text &&
         (this._flags.last_token.type !== p.OPERATOR ||
          '--' === this._flags.last_token.text ||
          '++' === this._flags.last_token.text))
       for (var i = this._tokens.peek();
            !(this._flags.mode !== g.Statement ||
              this._flags.if_block && l(i, 'else') || this._flags.do_block);)
         this.restore_mode();
     this._output.add_new_line(t) && (this._flags.multiline_frame = !0)
   }, y.prototype.print_token_line_indentation = function(t) {
     this._output.just_added_newline() &&
         (this._options.keep_array_indentation && t.newlines &&
                  ('[' === t.text || k(this._flags.mode)) ?
              (this._output.current_line.set_indent(-1),
               this._output.current_line.push(t.whitespace_before),
               this._output.space_before_token = !1) :
              this._output.set_indent(
                  this._flags.indentation_level, this._flags.alignment) &&
                  (this._flags.line_indent_level =
                       this._flags.indentation_level))
   }, y.prototype.print_token = function(t, e) {
     if (this._output.raw)
       this._output.add_raw_token(t);
     else {
       if (this._options.comma_first && t.previous &&
           t.previous.type === p.COMMA && this._output.just_added_newline() &&
           ',' === this._output.previous_line.last()) {
         var i = this._output.previous_line.pop();
         this._output.previous_line.is_empty() &&
             (this._output.previous_line.push(i), this._output.trim(!0),
              this._output.current_line.pop(), this._output.trim()),
             this.print_token_line_indentation(t), this._output.add_token(','),
             this._output.space_before_token = !0
       }
       e = e || t.text, this.print_token_line_indentation(t),
       this._output.non_breaking_space = !0, this._output.add_token(e),
     ...
     this._flags.indentation_level > 0 &&
         ...
         (this._flags.indentation_level -= 1,
          this._output.set_indent(
              this._flags.indentation_level, this._flags.alignment))
   }, y.prototype.set_mode = function(t) {
     ...
     this._flag_store.length > 0 &&
         (this._previous_flags = this._flags,
          ...
          this._previous_flags.mode === g.Statement &&
              m(this._output, this._previous_flags),
          this._output.set_indent(
              this._flags.indentation_level, this._flags.alignment))
   }, y.prototype.start_of_object_property = function() {
     return this._flags.parent.mode === g.ObjectLiteral &&
         this._flags.mode === g.Statement &&
         (':' === this._flags.last_token.text &&
              0 === this._flags.ternary_depth ||
          c(this._flags.last_token, ['get', 'set']))
   }, y.prototype.start_of_statement = function(t) {
     var e = !1;
     return !!(e = (e = (e = (e = (e = (e = (e = e ||
                                                 c(this._flags.last_token,
                                                   ['var', 'let', 'const']) &&
                                                     t.type === p.WORD) ||
                                            l(this._flags.last_token, 'do')) ||
                                       !(this._flags.parent.mode ===
                                             g.ObjectLiteral &&
                                         this._flags.mode === g.Statement) &&
                                           c(this._flags.last_token, x) &&
                                           !t.newlines) ||
                                  l(this._flags.last_token, 'else') &&
                                      !(l(t, 'if') && !t.comments_before)) ||
                        ...
                        this._flags.last_token.type === p.WORD &&
                            this._flags.mode === g.BlockStatement &&
                            !this._flags.in_case &&
                            !('--' === t.text || '++' === t.text) &&
                            'function' !== this._last_last_text &&
                            t.type !== p.WORD && t.type !== p.RESERVED) ||
                   this._flags.mode === g.ObjectLiteral &&
                       (':' === this._flags.last_token.text &&
                            0 === this._flags.ternary_depth ||
                        c(this._flags.last_token, ['get', 'set']))) &&
         (this.set_mode(g.Statement), this.indent(),
          this.handle_whitespace_and_comments(t, !0),
          this.start_of_object_property() ||
              this.allow_wrap_or_preserved_newline(
                  t, c(t, ['do', 'for', 'if', 'while'])),
          !0)
   }, y.prototype.handle_start_expr = function(t) {
     this.start_of_statement(t) || this.handle_whitespace_and_comments(t);
     var e = g.Expression;
     if ('[' === t.text) {
       if (this._flags.last_token.type === p.WORD ||
           ')' === this._flags.last_token.text)
         return c(this._flags.last_token, r) &&
                    (this._output.space_before_token = !0),
                this.print_token(t), this.set_mode(e), this.indent(),
                void (
       ...
       h(this._flags.last_token.type,
         [p.START_EXPR, p.END_EXPR, p.WORD, p.OPERATOR]) ||
           (this._output.space_before_token = !0)
     } else {
       if (this._flags.last_token.type === p.RESERVED)
         'for' === this._flags.last_token.text ?
             (this._output.space_before_token =
                  this._options.space_before_conditional,
              e = g.ForInitializer) :
             h(this._flags.last_token.text, ['if', 'while']) ?
             (this._output.space_before_token =
                  this._options.space_before_conditional,
              e = g.Conditional) :
             ...
             'import' === this._flags.last_token.text&& '' ===
                             t.whitespace_before ?
             this._output.space_before_token = !1 :
             (h(this._flags.last_token.text, r) ||
     ...
     ';' === this._flags.last_token.text ||
         ...
         this.print_token(t), this.set_mode(e),
         this._options.space_in_paren && (this._output.space_before_token = !0),
         this.indent()
   }, y.prototype.handle_end_expr = function(t) {
     ...
     this.handle_whitespace_and_comments(t),
         ...
         this.deindent(), this.print_token(t), this.restore_mode(),
         m(this._output, this._previous_flags),
         this._flags.do_while && this._previous_flags.mode === g.Conditional &&
         (this._previous_flags.mode = g.Expression, this._flags.do_block = !1,
          this._flags.do_while = !1)
   }, y.prototype.handle_start_block = function(t) {
     this.handle_whitespace_and_comments(t);
     var e = this._tokens.peek(), i = this._tokens.peek(1);
     'switch' === this._flags.last_word &&
             this._flags.last_token.type === p.END_EXPR ?
         (this.set_mode(g.BlockStatement), this._flags.in_case_statement = !0) :
         i &&
                 (h(i.text, [':', ',']) &&
                      h(e.type, [p.STRING, p.WORD, p.RESERVED]) ||
                  h(e.text, ['get', 'set', '...']) &&
                      h(i.type, [p.WORD, p.RESERVED])) ?
         h(this._last_last_text, ['class', 'interface']) ?
         this.set_mode(g.BlockStatement) :
         this.set_mode(g.ObjectLiteral) :
         this._flags.last_token.type === p.OPERATOR &&
                     '=>' === this._flags.last_token.text ?
         this.set_mode(g.BlockStatement) :
         h(this._flags.last_token.type,
           [p.EQUALS, p.START_EXPR, p.COMMA, p.OPERATOR]) ||
                         c(this._flags.last_token,
                           ['return', 'throw', 'import', 'default']) ?
         this.set_mode(g.ObjectLiteral) :
         this.set_mode(g.BlockStatement);
     var n = !e.comments_before && '}' === e.text,
         _ = n && 'function' === this._flags.last_word &&
         this._flags.last_token.type === p.END_EXPR;
     if (this._options.brace_preserve_inline) {
       ...
       } while (a.type !== p.EOF && (a.type !== p.END_BLOCK || a.opened !== t))
     }
     ('expand' === this._options.brace_style ||
      'none' === this._options.brace_style && t.newlines) &&
             !this._flags.inline_frame ?
         this._flags.last_token.type !== p.OPERATOR &&
                 (_ || this._flags.last_token.type === p.EQUALS ||
                  c(this._flags.last_token, f) &&
                      'else' !== this._flags.last_token.text) ?
         this._output.space_before_token = !0 :
         this.print_newline(!1, !0) :
         (!k(this._previous_flags.mode) ||
              this._flags.last_token.type !== p.START_EXPR &&
                  this._flags.last_token.type !== p.COMMA ||
              ((this._flags.last_token.type === p.COMMA ||
                this._options.space_in_paren) &&
          ...
          this._flags.last_token.type !== p.OPERATOR &&
              ...
              (this._flags.last_token.type !== p.START_BLOCK ||
                   ...
                   this._output.space_before_token = !0 :
                   this.print_newline())),
         this.print_token(t), this.indent(),
         n || this._options.brace_preserve_inline && this._flags.inline_frame ||
         this.print_newline()
   }, y.prototype.handle_end_block = function(t) {
     for (this.handle_whitespace_and_comments(t);
          this._flags.mode === g.Statement;)
       this.restore_mode();
     var e = this._flags.last_token.type === p.START_BLOCK;
     this._flags.inline_frame&& !e ?
         this._output.space_before_token = !0 :
         'expand' === this._options.brace_style ? e || this.print_newline() :
                                                  e ||
                 (k(this._flags.mode) && this._options.keep_array_indentation ?
                      (this._options.keep_array_indentation = !1,
                       this.print_newline(),
                       this._options.keep_array_indentation = !0) :
                      this.print_newline()),
         this.restore_mode(), this.print_token(t)
   }, y.prototype.handle_word = function(t) {
     if (t.type === p.RESERVED)
       if (h(t.text, ['set', 'get']) && this._flags.mode !== g.ObjectLiteral)
         t.type = p.WORD;
       else if ('import' === t.text && '(' === this._tokens.peek().text)
         t.type = p.WORD;
       else if (h(t.text, ['as', 'from']) && !this._flags.import_block)
         t.type = p.WORD;
       else if (this._flags.mode === g.ObjectLiteral) {
         ':' === this._tokens.peek().text && (t.type = p.WORD)
       }
     if (this.start_of_statement(t) ?
             c(this._flags.last_token, ['var', 'let', 'const']) &&
                 t.type === p.WORD && (this._flags.declaration_statement = !0) :
             !t.newlines || w(this._flags.mode) ||
                     this._flags.last_token.type === p.OPERATOR &&
                         '--' !== this._flags.last_token.text &&
                         '++' !== this._flags.last_token.text ||
                     this._flags.last_token.type === p.EQUALS ||
       ...
       if (l(t, 'while'))
         return this._output.space_before_token = !0, this.print_token(t),
                this._output.space_before_token = !0,
                void (this._flags.do_while = !0);
       this.print_newline(), this._flags.do_block = !1
     }
     if (this._flags.if_block)
       if (!this._flags.else_block && l(t, 'else'))
         this._flags.else_block = !0;
       else {
         for (; this._flags.mode === g.Statement;) this.restore_mode();
         this._flags.if_block = !1, this._flags.else_block = !1
       }
     if (this._flags.in_case_statement && c(t, ['case', 'default']))
       return this.print_newline(),
              (this._flags.case_body || this._options.jslint_happy) &&
                  (this.deindent(), this._flags.case_body = !1),
              this.print_token(t), void (this._flags.in_case = !0);
     if (this._flags.last_token.type !== p.COMMA &&
                 this._flags.last_token.type !== p.START_EXPR &&
                 this._flags.last_token.type !== p.EQUALS &&
                 this._flags.last_token.type !== p.OPERATOR ||
             this.start_of_object_property() ||
             this.allow_wrap_or_preserved_newline(t),
         l(t, 'function'))
       return (h(this._flags.last_token.text, ['}', ';']) ||
               this._output.just_added_newline() &&
                   !h(this._flags.last_token.text,
                      ['(', '[', '{', ':', '=', ',']) &&
                   this._flags.last_token.type !== p.OPERATOR) &&
                  (this._output.just_added_blankline() || t.comments_before ||
                   (this.print_newline(), this.print_newline(!0))),
              this._flags.last_token.type === p.RESERVED ||
                      this._flags.last_token.type === p.WORD ?
                  c(this._flags.last_token, ['get', 'set', 'new', 'export']) ||
                          c(this._flags.last_token, x) ?
                  this._output.space_before_token = !0 :
                  l(this._flags.last_token, 'default') &&
                  ...
                  this._output.space_before_token = !0 :
                  (this._flags.multiline_frame ||
                   !w(this._flags.mode) && !k(this._flags.mode)) &&
                          this.print_newline(),
                  this.print_token(t), void (this._flags.last_word = t.text);
     var e = 'NONE';
     (this._flags.last_token.type === p.END_BLOCK ?
          this._previous_flags.inline_frame ?
          e = 'SPACE' :
          c(t, ['else', 'catch', 'finally', 'from']) ?
          'expand' === this._options.brace_style ||
          ...
          e = 'NEWLINE' :
          this._flags.last_token.type === p.SEMICOLON&& this._flags.mode ===
                  g.BlockStatement ?
          e = 'NEWLINE' :
          this._flags.last_token.type === p.SEMICOLON && w(this._flags.mode) ?
          e = 'SPACE' :
          ...
          this._flags.last_token.type === p.END_EXPR &&
                                  (this._output.space_before_token = !0,
                                   e = 'NEWLINE'),
      c(t, r) && ')' !== this._flags.last_token.text &&
          (e = this._flags.inline_frame ||
                   'else' === this._flags.last_token.text ||
                   'export' === this._flags.last_token.text ?
               'SPACE' :
               'NEWLINE'),
      c(t, ['else', 'catch', 'finally'])) ?
         (this._flags.last_token.type !== p.END_BLOCK ||
          this._previous_flags.mode !== g.BlockStatement ||
          'expand' === this._options.brace_style ||
          'end-expand' === this._options.brace_style ||
          'none' === this._options.brace_style && t.newlines) &&
                 !this._flags.inline_frame ?
         ...
         this._flags.last_token.type === p.START_EXPR &&
                                 c(t, ['var', 'let', 'const']) ||
                             ':' === this._flags.last_token.text ||
                             (l(t, 'if') && l(t.previous, 'else') ?
                                  this._output.space_before_token = !0 :
                                  this.print_newline()) :
         c(t, r) && ')' !== this._flags.last_token.text &&
                             this.print_newline() :
         this._flags.multiline_frame && k(this._flags.mode) &&
                     ',' === this._flags.last_token.text &&
                     '}' === this._last_last_text ?
         this.print_newline() :
         'SPACE' === e && (this._output.space_before_token = !0);
     !t.previous ||
         t.previous.type !== p.WORD && t.previous.type !== p.RESERVED ||
         (this._output.space_before_token = !0),
         this.print_token(t), this._flags.last_word = t.text,
                              t.type === p.RESERVED &&
         ('do' === t.text ? this._flags.do_block = !0 :
                            'if' === t.text ? this._flags.if_block = !0 :
                                              'import' === t.text ?
                                              this._flags.import_block = !0 :
                                              this._flags.import_block &&
                          l(t, 'from') && (this._flags.import_block = !1))
   }, y.prototype.handle_semicolon = function(t) {
     this.start_of_statement(t) ? this._output.space_before_token = !1 :
                                  this.handle_whitespace_and_comments(t);
     for (var e = this._tokens.peek();
          !(this._flags.mode !== g.Statement ||
            this._flags.if_block && l(e, 'else') || this._flags.do_block);)
       this.restore_mode();
     this._flags.import_block && (this._flags.import_block = !1),
         this.print_token(t)
   }, y.prototype.handle_string = function(t) {
     this.start_of_statement(t) ?
         ...
         (this.handle_whitespace_and_comments(t),
          this._flags.last_token.type === p.RESERVED ||
              ...
              this.print_newline()),
         this.print_token(t)
   }, y.prototype.handle_equals = function(t) {
     this.start_of_statement(t) || this.handle_whitespace_and_comments(t),
         ...
         this._output.space_before_token = !0
   }, y.prototype.handle_comma = function(t) {
     this.handle_whitespace_and_comments(t, !0), this.print_token(t),
         this._output.space_before_token = !0,
         this._flags.declaration_statement ?
         (w(this._flags.parent.mode) &&
         ...
         this._flags.mode === g.ObjectLiteral ||
                 this._flags.mode === g.Statement &&
                     this._flags.parent.mode === g.ObjectLiteral ?
         (this._flags.mode === g.Statement && this.restore_mode(),
          this._flags.inline_frame || this.print_newline()) :
         this._options.comma_first && this.allow_wrap_or_preserved_newline(t)
   }, y.prototype.handle_operator = function(t) {
     var e = '*' === t.text &&
         (c(this._flags.last_token, ['function', 'yield']) ||
          h(this._flags.last_token.type,
            [p.START_BLOCK, p.COMMA, p.END_BLOCK, p.SEMICOLON])),
         i = h(t.text, ['-', '+']) &&
         (h(this._flags.last_token.type,
            [p.START_BLOCK, p.START_EXPR, p.EQUALS, p.OPERATOR]) ||
          h(this._flags.last_token.text, r) ||
          ',' === this._flags.last_token.text);
     if (this.start_of_statement(t))
       ;
     ...
     if (c(this._flags.last_token, f))
       return this._output.space_before_token = !0, void this.print_token(t);
     if ('*' !== t.text || this._flags.last_token.type !== p.DOT)
       if ('::' !== t.text) {
         if (this._flags.last_token.type === p.OPERATOR &&
                 h(this._options.operator_position, b) &&
                 this.allow_wrap_or_preserved_newline(t),
             ':' === t.text && this._flags.in_case)
           return this._flags.case_body = !0, this.indent(),
                  this.print_token(t), this.print_newline(),
         ...
         if (':' === t.text ?
             ...
             !i && !e && this._options.preserve_newlines && h(t.text, o)) {
           var u = ':' === t.text, l = u && a, m = u && !a;
           switch (this._options.operator_position) {
             case d.before_newline:
               return this._output.space_before_token = !m, this.print_token(t),
                      u && !l || this.allow_wrap_or_preserved_newline(t),
                      void (this._output.space_before_token = !0);
             case d.after_newline:
               return this._output.space_before_token = !0,
                      !u || l ? this._tokens.peek().newlines ?
                                this.print_newline(!1, !0) :
                                this.allow_wrap_or_preserved_newline(t) :
                                this._output.space_before_token = !1,
                      this.print_token(t),
             ...
             case d.preserve_newline:
               return m || this.allow_wrap_or_preserved_newline(t),
                      _ = !(this._output.just_added_newline() || m),
                      this._output.space_before_token = _, this.print_token(t),
                      void (this._output.space_before_token = !0)
           }
         }
         if (e) {
           ...
           s = k && h(k.type, [p.WORD, p.RESERVED])
         } else
           '...' === t.text ?
               (this.allow_wrap_or_preserved_newline(t),
                _ = this._flags.last_token.type === p.START_BLOCK, s = !1) :
               (h(t.text, ['--', '++', '!', '~']) || i) &&
                   (this._flags.last_token.type !== p.COMMA &&
                            this._flags.last_token.type !== p.START_EXPR ||
                        this.allow_wrap_or_preserved_newline(t),
                    ...
                    (this._flags.mode !== g.BlockStatement ||
                     this._flags.inline_frame) &&
                        ...
                        '{' !== this._flags.last_token.text &&
                            ';' !== this._flags.last_token.text ||
                        this.print_newline());
         this._output.space_before_token = this._output.space_before_token || _,
         this.print_token(t), this._output.space_before_token = s
       } else
         this.print_token(t);
     else
       this.print_token(t)
   }, y.prototype.handle_block_comment = function(t, e) {
     if (this._output.raw)
       return this._output.add_raw_token(t),
              void (
                  t.directives && 'end' === t.directives.preserve &&
                  (this._output.raw = this._options.test_output_raw));
     if (t.directives)
       return this.print_newline(!1, e), this.print_token(t),
     ...
     var i, n = function(t) {
       for (var e = [],
                i = (t = t.replace(s.allLineBreaks, '\n')).indexOf('\n');
            - 1 !== i;)
         e.push(t.substring(0, i)), i = (t = t.substring(i + 1)).indexOf('\n');
       return t.length && e.push(t), e
     }(t.text), _ = !1, a = !1, u = t.whitespace_before, r = u.length;
     if (this.print_newline(!1, e), this.print_token(t, n[0]),
         this.print_newline(!1, e), n.length > 1) {
       for (_ =
                function(t, e) {
           ...
           _ && (this._flags.alignment = 1), i = 0;
            i < n.length; i++)
         _ ? this.print_token(t, n[i].replace(/^\s+/g, '')) :
             a && n[i] ? this.print_token(t, n[i].substring(r)) :
                         (this._output.current_line.set_indent(-1),
                          this._output.add_token(n[i])),
             this.print_newline(!1, e);
       this._flags.alignment = 0
     }
   }, y.prototype.handle_comment = function(t, e) {
     t.newlines ? this.print_newline(!1, e) : this._output.trim(!0),
         this._output.space_before_token = !0, this.print_token(t),
         this.print_newline(!1, e)
   }, y.prototype.handle_dot = function(t) {
     this.start_of_statement(t) || this.handle_whitespace_and_comments(t, !0),
         ...
         this._output.just_added_newline() && this.deindent(),
         this.print_token(t)
   }, y.prototype.handle_unknown = function(t, e) {
     this.print_token(t),
         '\n' === t.text[t.text.length - 1] && this.print_newline(!1, e)
   }, y.prototype.handle_eof = function(t) {
     for (; this._flags.mode === g.Statement;) this.restore_mode();
     this.handle_whitespace_and_comments(t)
   }, t.exports.Beautifier = y
        },
        function(t, e, i) {
          'use strict';
          function n(t) {
          ...
          n.prototype.restart = function() {
            ...
            var e = null;
            return t = t || 0,
                   (t += this.__position) >= 0 && t < this.__tokens_length &&
                       (e = this.__tokens[t]),
                   e
          }, n.prototype.add = function(t) {
            this.__parent_token && (t.parent = this.__parent_token),
                this.__tokens.push(t), this.__tokens_length += 1
        ...
        function(t, e, i) {
          ...
          function _(t, e) {
            n.call(this, t, e),
                e ? this._line_regexp = this._input.get_regexp(e._line_regexp) :
          ...
          _.prototype.__set_whitespace_patterns = function(t, e) {
            ...
            t.lastIndex = 0;
            for (var i = 0, n = [], _ = t.exec(e); _;)
              n.push(e.substring(i, _.index)), i = _.index + _[0].length,
                                               _ = t.exec(e);
            return i < e.length ? n.push(e.substring(i, e.length)) : n.push(''),
                   n
          }, t.exports.WhitespacePattern = _
        },
        function(t, e, i) {
          'use strict';
          var n = i(20).Beautifier, _ = i(11).Options;
          t.exports = function(t, e) {
            return new n(t, e).beautify()
          }, t.exports.defaultOptions = function() {
            return new _
        ...
        function(t, e, i) {
          'use strict';
          var n = i(11).Options, _ = i(3).Output, s = i(5).InputScanner,
              a = new (0, i(6).Directives)(/\/\*/, /\*\//), u = /\r\n|[\r\n]/,
              r = /\r\n|[\r\n]/g, o = /\s/, p = /(?:\s|\n)+/g,
              h = /\/\*(?:[\s\S]*?)((?:\*\/)|$)/g,
              l = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
          function c(t, e) {
            this._source_text = t || '', this._options = new n(e),
   ...
   c.prototype.eatWhitespace = function(t) {
     for (var e = o.test(this._input.peek()), i = !0;
          o.test(this._input.peek());)
       this._ch = this._input.next(),
       t && '\n' === this._ch && (this._options.preserve_newlines || i) &&
           (i = !1, this._output.add_new_line(!0));
     return e
     ...
     this._output.set_indent(this._indentLevel),
         this._output.non_breaking_space = !0, this._output.add_token(t)
     ...
     'auto' === e && (e = '\n', t && u.test(t || '') && (e = t.match(u)[0]));
     var i = (t = t.replace(r, '\n')).match(/^[\t ]*/)[0];
     this._output = new _(this._options, i), this._input = new s(t),
     this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
     for (var n, c, f = 0, d = !1, b = !1, g = !1, m = !1, k = !1, w = this._ch;
          n = '' !== this._input.read(p), c = w, this._ch = this._input.next(),
                    w = this._ch, this._ch;)
       if ('/' === this._ch && '*' === this._input.peek()) {
         this._output.add_new_line(), this._input.back();
         var y = this._input.read(h), x = a.get_directives(y);
         x && 'start' === x.ignore && (y += a.readIgnored(this._input)),
             this.print_string(y), this.eatWhitespace(!0),
             this._output.add_new_line()
       } else if ('/' === this._ch && '/' === this._input.peek())
         this._output.space_before_token = !0, this._input.back(),
         this.print_string(this._input.read(l)), this.eatWhitespace(!0);
       else if ('@' === this._ch)
         if (this.preserveSingleSpace(n), '{' === this._input.peek())
           ...
           v.match(/[ :]$/) &&
               (v = this.eatString(': ').replace(/\s$/, ''),
                this.print_string(v), this._output.space_before_token = !0),
               'extend' === (v = v.replace(/\s$/, '')) ?
               m = !0 :
               'import' === v && (k = !0),
               v in this.NESTED_AT_RULE ?
               (this._nestedLevel += 1,
                v in this.CONDITIONAL_GROUP_RULE && (g = !0)) :
               d || 0 !== f || -1 === v.indexOf(':') || (b = !0, this.indent())
         }
       else
         '#' === this._ch && '{' === this._input.peek() ?
             (this.preserveSingleSpace(n),
              this.print_string(this._ch + this.eatString('}'))) :
             '{' === this._ch ?
             (b && (b = !1, this.outdent()), this.indent(),
              this._output.space_before_token = !0, this.print_string(this._ch),
              g ? (g = !1, d = this._indentLevel > this._nestedLevel) :
                  d = this._indentLevel >= this._nestedLevel,
              this._options.newline_between_rules && d &&
             ...
             (this.outdent(), this._output.add_new_line(),
              '{' === c && this._output.trim(!0), k = !1, m = !1,
              b && (this.outdent(), b = !1), this.print_string(this._ch),
              d = !1, this._nestedLevel && this._nestedLevel--,
              this.eatWhitespace(!0), this._output.add_new_line(),
              this._options.newline_between_rules &&
                  !this._output.just_added_blankline() &&
                  '}' !== this._input.peek() && this._output.add_new_line(!0)) :
             ':' === this._ch ?
             !d && !g || this._input.lookBack('&') ||
                                 this.foundNestedPseudoClass() ||
                                 this._input.lookBack('(') || m ?
             ...
             (this.print_string(':'),
              b ||
                  (b = !0, this._output.space_before_token = !0,
                   this.eatWhitespace(!0), this.indent())) :
             '"' === this._ch || '\'' === this._ch ?
             (this.preserveSingleSpace(n),
              this.print_string(this._ch + this.eatString(this._ch)),
              this.eatWhitespace(!0)) :
             ';' === this._ch ?
             (b && (this.outdent(), b = !1), m = !1, k = !1,
              this.print_string(this._ch), this.eatWhitespace(!0),
             ...
             (this.print_string(this._ch), this.eatWhitespace(),
              ...
              ')' === this._ch || '"' === this._ch || '\'' === this._ch ?
                  ...
                  this._ch &&
                      this.print_string(this._ch + this.eatString(')'))) :
             (f++, this.preserveSingleSpace(n), this.print_string(this._ch),
              this.eatWhitespace()) :
             ')' === this._ch ?
             (this.print_string(this._ch), f--) :
             ',' === this._ch ?
             (this.print_string(this._ch), this.eatWhitespace(!0),
              this._options.selector_separator_newline && !b && f < 1 && !k ?
                  this._output.add_new_line() :
                  this._output.space_before_token = !0) :
             ('>' === this._ch || '+' === this._ch || '~' === this._ch) && !b &&
                                                     f < 1 ?
             this._options.space_around_combinator ?
             (this._output.space_before_token = !0, this.print_string(this._ch),
              this._output.space_before_token = !0) :
             (this.print_string(this._ch), this.eatWhitespace(),
              this._ch && o.test(this._ch) && (this._ch = '')) :
             ']' === this._ch ?
             this.print_string(this._ch) :
             '[' === this._ch ?
             (this.preserveSingleSpace(n), this.print_string(this._ch)) :
             '=' === this._ch ?
             (this.eatWhitespace(), this.print_string('='),
              o.test(this._ch) && (this._ch = '')) :
             '!' === this._ch ?
     ...
     return this._output.get_code(e)
        ...
        function(t, e, i) {
          'use strict';
          var n = i(22).Beautifier, _ = i(12).Options;
        ...
        function(t, e, i) {
          'use strict';
          var n = i(12).Options, _ = i(3).Output, s = i(13).Tokenizer,
              a = i(13).TOKEN, u = /\r\n|[\r\n]/, r = /\r\n|[\r\n]/g,
              o = function(t, e) {
                this.indent_level = 0, this.alignment_size = 0,
          ...
          o.prototype.current_line_has_match = function(t) {
            ...
            t.text &&
                (this._output.set_indent(
                     this.indent_level, this.alignment_size),
          ...
          var p = function(t, e) {
            var i = null, n = null;
            return e.closed ?
                ('script' === t ? i = 'text/javascript' :
                                  'style' === t && (i = 'text/css'),
                 (i =
                      function(t) {
                        for (var e = null, i = t.next;
                             i.type !== a.EOF && t.closed !== i;) {
                          if (i.type === a.ATTRIBUTE && 'type' === i.text) {
                            i.next && i.next.type === a.EQUALS && i.next.next &&
                                i.next.next.type === a.VALUE &&
                                (e = i.next.next.text);
                            break
                          }
                          i = i.next
          ...
          function l(t, e, i) {
            this.parent = t || null, this.tag = e ? e.tag_name : '',
            this.indent_level = i || 0, this.parser_token = e || null
          }
          function c(t) {
            this._printer = t, this._current_frame = null
          }
          function f(t, e, i, _) {
            this._source_text = t || '', e = e || {}, this._js_beautify = i,
            this._css_beautify = _, this._tag_stack = null;
            var s = new n(e, 'html');
            this._options = s,
   ...
   c.prototype.record_tag = function(t) {
     ...
     'auto' === this._options.eol &&
         (e = '\n', t && u.test(t) && (e = t.match(u)[0]));
     var i = (t = t.replace(r, '\n')).match(/^[\t ]*/)[0],
         n = {text: '', type: ''}, _ = new d, p = new o(this._options, i),
         h = new s(t, this._options).tokenize();
     this._tag_stack = new c(p);
     for (var l = null, f = h.next(); f.type !== a.EOF;)
       f.type === a.TAG_OPEN || f.type === a.COMMENT ?
           _ = l = this._handle_tag_open(p, f, _, n) :
           f.type === a.ATTRIBUTE || f.type === a.EQUALS ||
                   f.type === a.VALUE || f.type === a.TEXT&& !_.tag_complete ?
           l = this._handle_inside_tag(p, f, _, h) :
           f.type === a.TAG_CLOSE ?
           l = this._handle_tag_close(p, f, _) :
           f.type === a.TEXT ? l = this._handle_text(p, f, _) :
                               p.add_raw_token(f),
           n = l, f = h.next();
     return p._output.get_code(e)
   }, f.prototype._handle_tag_close = function(t, e, i) {
     var n = {text: e.text, type: e.type};
     return t.alignment_size = 0, i.tag_complete = !0,
            t.set_space_before_token(
                e.newlines || '' !== e.whitespace_before, !0),
            i.is_unformatted ?
                t.add_raw_token(e) :
                ('<' === i.tag_start_char &&
                     (t.set_space_before_token('/' === e.text[0], !0),
                      this._is_wrap_attributes_force_expand_multiline &&
                          i.has_wrapped_attrs && t.print_newline(!1)),
                 t.print_token(e)),
            !i.indent_content || i.is_unformatted || i.is_content_unformatted ||
                (t.indent(), i.indent_content = !1),
            i.is_inline_element || i.is_unformatted ||
                i.is_content_unformatted || t.set_wrap_point(),
            n
   }, f.prototype._handle_inside_tag = function(t, e, i, n) {
     var _ = i.has_wrapped_attrs, s = {text: e.text, type: e.type};
     if (t.set_space_before_token(e.newlines || '' !== e.whitespace_before, !0),
         i.is_unformatted)
       t.add_raw_token(e);
     else if ('{' === i.tag_start_char && e.type === a.TEXT)
       t.print_preserved_newlines(e) ? (e.newlines = 0, t.add_raw_token(e)) :
                                       t.print_token(e);
     else {
       if (e.type === a.ATTRIBUTE ?
               (t.set_space_before_token(!0), i.attr_count += 1) :
               e.type === a.EQUALS ?
               t.set_space_before_token(!1) :
               e.type === a.VALUE && e.previous.type === a.EQUALS &&
                       t.set_space_before_token(!1),
           e.type === a.ATTRIBUTE && '<' === i.tag_start_char &&
               ((this._is_wrap_attributes_preserve ||
                 this._is_wrap_attributes_preserve_aligned) &&
                    (t.traverse_whitespace(e), _ = _ || 0 !== e.newlines),
                this._is_wrap_attributes_force)) {
         var u = i.attr_count > 1;
         if (this._is_wrap_attributes_force_expand_multiline &&
             1 === i.attr_count) {
           var r, o = !0, p = 0;
           do {
             if ((r = n.peek(p)).type === a.ATTRIBUTE) {
               o = !1;
               break
             }
             p += 1
           } while (p < 4 && r.type !== a.EOF && r.type !== a.TAG_CLOSE);
           u = !o
         }
         u && (t.print_newline(!1), _ = !0)
       }
       t.print_token(e), _ = _ || t.previous_token_wrapped(),
                         i.has_wrapped_attrs = _
     }
     return s
   }, f.prototype._handle_text = function(t, e, i) {
     var n = {text: e.text, type: 'TK_CONTENT'};
     return i.custom_beautifier_name ?
     ...
     if ('' !== e.text) {
       t.print_newline(!1);
       var _, s = e.text, a = 1;
       'javascript' === i.custom_beautifier_name&& 'function' ==
               typeof this._js_beautify ?
           _ = this._js_beautify :
           'css' === i.custom_beautifier_name&& 'function' ==
                   typeof this._css_beautify ?
           _ = this._css_beautify :
           'html' === i.custom_beautifier_name &&
                   (_ =
                        function(t, e) {
                          return new f(t, e, n._js_beautify, n._css_beautify)
                              .beautify()
                        }),
       ...
       if (s = s.replace(/\n[ \t]*$/, ''), _) {
         ...
         r.prototype = this._options.raw_options, s = _(u + s, new r)
       } else {
         var o = e.whitespace_before;
         o && (s = s.replace(new RegExp('\n(' + o + ')?', 'g'), '\n')),
             s = u + s.replace(/\n/g, '\n' + u)
       }
       s &&
           (e.text = s, e.whitespace_before = '', e.newlines = 0,
            t.add_raw_token(e), t.print_newline(!0))
     }
   }, f.prototype._handle_tag_open = function(t, e, i, n) {
     var _ = this._get_tag_open_token(e);
     return (i.is_unformatted || i.is_content_unformatted) &&
                    e.type === a.TAG_OPEN && 0 === e.text.indexOf('</') ?
                t.add_raw_token(e) :
                (t.traverse_whitespace(e),
                 this._set_tag_position(t, e, _, i, n),
                 _.is_inline_element || t.set_wrap_point(), t.print_token(e)),
            (this._is_wrap_attributes_force_aligned ||
             this._is_wrap_attributes_aligned_multiple ||
             this._is_wrap_attributes_preserve_aligned) &&
                (_.alignment_size = e.text.length + 1),
            _.tag_complete || _.is_unformatted ||
                (t.alignment_size = _.alignment_size),
            _
   };
          var d = function(t, e) {
            var i;
            (this.parent = t || null, this.text = '', this.type = 'TK_TAG_OPEN',
             this.tag_name = '', this.is_inline_element = !1,
             this.is_unformatted = !1, this.is_content_unformatted = !1,
             this.is_empty_element = !1, this.is_start_tag = !1,
             this.is_end_tag = !1, this.indent_content = !1,
             this.multiline_content = !1, this.custom_beautifier_name = null,
             this.start_tag_token = null, this.attr_count = 0,
             this.has_wrapped_attrs = !1, this.alignment_size = 0,
             this.tag_complete = !1, this.tag_start_char = '',
             this.tag_check = '', e) ?
                (this.tag_start_char = e.text[0], this.text = e.text,
                 '<' === this.tag_start_char ?
                     (i = e.text.match(/^<([^\s>]*)/),
                 ...
                 this.tag_name = this.is_start_tag ? this.tag_check :
          ...
          f.prototype
            ...
            return e.alignment_size = this._options.wrap_attributes_indent_size,
                   e.is_end_tag = e.is_end_tag ||
                       h(e.tag_check, this._options.void_elements),
                   e.is_empty_element =
                       e.tag_complete || e.is_start_tag && e.is_end_tag,
                   e.is_unformatted = !e.tag_complete &&
                       h(e.tag_check, this._options.unformatted),
                   e.is_content_unformatted = !e.is_empty_element &&
                       h(e.tag_check, this._options.content_unformatted),
                   e.is_inline_element = h(e.tag_name, this._options.inline) ||
                       '{' === e.tag_start_char,
                   e
          },
   f.prototype._set_tag_position = function(t, e, i, n, _) {
     if (i.is_empty_element ||
             (i.is_end_tag ?
                  i.start_tag_token = this._tag_stack.try_pop(i.tag_name) :
                  (this._do_optional_end_element(i) &&
                       (i.is_inline_element ||
                        (i.parent && (i.parent.multiline_content = !0),
                         t.print_newline(!1))),
                   this._tag_stack.record_tag(i),
                   'script' !== i.tag_name && 'style' !== i.tag_name ||
                       i.is_unformatted || i.is_content_unformatted ||
                       (i.custom_beautifier_name = p(i.tag_check, e)))),
         h(i.tag_check, this._options.extra_liners) &&
             (t.print_newline(!1),
       ...
       '!--' === i.tag_name && _.type === a.TAG_CLOSE && n.is_end_tag &&
               -1 === i.text.indexOf('\n') ||
       ...
       i.is_unformatted || i.is_content_unformatted ?
           i.is_inline_element || i.is_unformatted || t.print_newline(!1) :
           i.is_end_tag ?
           (i.start_tag_token && i.start_tag_token.multiline_content ||
            !(i.is_inline_element || n.is_inline_element ||
              _.type === a.TAG_CLOSE && i.start_tag_token === n ||
              'TK_CONTENT' === _.type)) &&
                   t.print_newline(!1) :
                                                          ...
                                                          (e = (e = e ||
                                                               ...
                                                               this._tag_stack
                                                                   .try_pop(
                                                                       'th',
                                                                       ['tr'])),
                  t.parent = this._tag_stack.get_parser_token(), e
